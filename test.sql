CREATE DATABASE  IF NOT EXISTS `athanaeum_library` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `athanaeum_library`;
-- MySQL dump 10.13  Distrib 8.0.28, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: athanaeum_library
-- ------------------------------------------------------
...
CREATE TABLE `purchased_books` (
  ...
  KEY `book_id` (`book_id`),
  KEY `purchasing_id` (`purchasing_id`),
  CONSTRAINT `purchased_books_ibfk_1` FOREIGN KEY (`book_id`) REFERENCES `books` (`id`),
  CONSTRAINT `purchased_books_ibfk_2` FOREIGN KEY (`purchasing_id`) REFERENCES `purchasings` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping routines for database 'athanaeum_library'
--
...
-- Dump completed on 2022-06-02 21:42:24
